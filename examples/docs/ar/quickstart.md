...
```javascript
import Vue from 'vue';
import ElementUI from 'element-ui-international';
import 'element-ui-international/lib/theme-chalk/index.css';
...
```json
{
  ...
  "plugins": [
    [
      "component",
      {
        "libraryName": "element-ui-international",
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'element-ui-international';
import App from './App.vue';
...
```js
import Vue from 'vue';
import { Button } from 'element-ui-international';
