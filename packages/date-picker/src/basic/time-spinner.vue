...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'element-ui-international/src/utils/date-util';
  import ElScrollbar from 'element-ui-international/packages/scrollbar';
  import RepeatClick from 'element-ui-international/src/directives/repeat-click';
