<script type="text/jsx">
  ...
  import Menubar from 'element-ui-international/src/utils/menu/aria-menubar';
  import { addClass, removeClass, hasClass } from 'element-ui-international/src/utils/dom';
